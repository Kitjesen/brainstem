...
/// Bindings for `src/onnx_runtime.h`.
///
...
final class OrtCompileApi extends ffi.Struct {
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      OrtStatusPtr Function(
        ...
        ffi.Pointer<ffi.WChar> input_model_path,
      )
    >
  >
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      OrtStatusPtr Function(
        ffi.Pointer<OrtModelCompilationOptions> model_compile_options,
        ffi.Pointer<ffi.WChar> output_model_path,
      )
    >
  >
  ...
  external ffi.Pointer<
    ffi.NativeFunction<
      OrtStatusPtr Function(
        ffi.Pointer<OrtModelCompilationOptions> model_compile_options,
        ffi.Pointer<ffi.WChar> external_initializers_file_path,
