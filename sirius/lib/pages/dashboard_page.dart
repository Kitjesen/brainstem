...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Future<void> _connect() async {
    ...
    if (widget.grpc.connected) {
      AppToast.showSuccess(
        context,
        '已连接 ${widget.grpc.host}:${widget.grpc.port}',
      );
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _StatCard(
                          ...
                          label: '推理频率',
                          value: g.historyHz.toStringAsFixed(1),
                          unit: 'Hz',
                        ),
                      ),
                      hg,
                      Expanded(
                        child: _StatCard(
                          ...
                          label: 'IMU 频率',
                          value: g.imuHz.toStringAsFixed(1),
                          unit: 'Hz',
                        ),
                      ),
                      hg,
                      Expanded(
                        child: _StatCard(
                          ...
                          label: '关节频率',
                          value: g.jointHz.toStringAsFixed(1),
                          unit: 'Hz',
                        ),
                      ),
                    ],
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          SizedBox(
            width: 120,
            child: _inp(c, _hC, 'IP', !g.connected && !g.isReconnecting),
          ),
          const SizedBox(width: 5),
          SizedBox(
            width: 56,
            child: _inp(c, _pC, 'Port', !g.connected && !g.isReconnecting),
          ),
          const SizedBox(width: 4),
          if (!g.connected && !g.isReconnecting)
          ...
          _ConnBtn(
            ...
            onTap: g.connected
                ? () {
                    widget.grpc.disconnect();
                    AppToast.showSuccess(context, '已断开');
                  }
                : g.isReconnecting
                ? () {
                    widget.grpc.disconnect();
                    AppToast.showSuccess(context, '已取消重连');
                  }
                : (_busy ? null : _connect),
          ),
        ],
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: BorderRadius.circular(7),
          borderSide: BorderSide(color: AppTheme.brand.withValues(alpha: 0.3)),
        ),
      ),
    );
  }
  ...
  Widget _controlRow(BuildContext c, GrpcService g) {
    ...
    // 6 CMS states matching han_dog_brain S class
      ...
      child: Row(
        children: [
          ...
          _ActBtn(
            ...
            onTap: g.connected ? g.enable : null,
          ),
          ...
          _ActBtn(
            ...
            color: AppTheme.red,
            onTap: g.connected ? g.disable : null,
          ),
          const SizedBox(width: 6),
          _ActBtn(
            label: '站立',
            ...
            color: AppTheme.teal,
            onTap: g.connected ? g.standUp : null,
          ),
          const SizedBox(width: 6),
          _ActBtn(
            label: '坐下',
            ...
            color: AppTheme.orange,
            onTap: g.connected ? g.sitDown : null,
          ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  g.params != null && g.params!.hasRobot()
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              ...
              blurRadius: _hov ? 20 : 8,
              offset: Offset(0, _hov ? 8 : 2),
            ),
          ],
        ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ...List.generate(4, (ji) {
                      ...
                      final pos = j != null && j.position.values.length > idx
                          ? j.position.values[idx]
                          : 0.0;
                      final vel = j != null && j.velocity.values.length > idx
                          ? j.velocity.values[idx]
                          : 0.0;
                      ...
                      return Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                trq.toStringAsFixed(1),
                                style: TextStyle(
                                  fontSize: 10,
                                  color: trq.abs() > 5
                                      ? AppTheme.red
                                      : cs.onSurface.withValues(alpha: 0.5),
                                  fontWeight: trq.abs() > 5
                                      ? FontWeight.w600
                                      : FontWeight.w400,
                                  fontFeatures: const [
                                    FontFeature.tabularFigures(),
                            ...
                            SizedBox(
                              ...
                              child: ClipRRect(
                                ...
                                child: LinearProgressIndicator(
                                  value: (trq.abs() / 10.0).clamp(0.0, 1.0),
                                  minHeight: 6,
...
class _QuickParamsPanel extends StatefulWidget {
  ...
  @override
  State<_QuickParamsPanel> createState() => _QuickParamsPanelState();
}
  ...
  Widget build(BuildContext context) {
    ...
    if (p != null) {
      ...
      if (widget.grpc.maxTorqueEver > 0) {
        items.add((
          '峰值力矩',
          '${widget.grpc.maxTorqueEver.toStringAsFixed(1)} Nm',
        ));
      }
...
class _DeviceInfoCardState extends State<_DeviceInfoCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final sessionDur = g.connectTime != null
        ...
        : '--';
    final rtt = g.lastRttMs > 0
        ? '${g.lastRttMs.toStringAsFixed(0)} ms'
        : '-- ms';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          _InfoChip(
            label: '行走时间',
            value: g.walkActiveMs > 0
                ? _fmt(Duration(milliseconds: g.walkActiveMs))
                : '--',
          ),
          const SizedBox(width: 20),
          _InfoChip(
            label: '峰值力矩',
            value: g.maxTorqueEver > 0
                ? '${g.maxTorqueEver.toStringAsFixed(1)} Nm'
                : '-- Nm',
            valueColor: g.maxTorqueEver > 8
                ? AppTheme.red
                : g.maxTorqueEver > 5
                ? AppTheme.orange
                : null,
      ...
      if (maxTrq > _torqueWarnNm) {
        ...
        alarms.add(
          _Alarm(
            ...
            message:
                '关节力矩过高：${legNames[maxIdx]}-${jNames[maxIdx]}  ${maxTrq.toStringAsFixed(1)} Nm',
    ...
    showDialog(
      ...
      builder: (dCtx) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text(
              '${widget.currentIp}:${widget.currentPort}',
              style: TextStyle(
                fontSize: 11,
                color: Theme.of(
                  dCtx,
  ...
  Widget build(BuildContext context) {
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        onSecondaryTap: () =>
            _showList(context), // right-click always shows list
        child: AnimatedContainer(
        ...
        child: devices.isEmpty
            ...
            : ListView.builder(
                ...
                itemBuilder: (_, i) {
                  final d = devices[i];
                  final isCurrent =
                      d.ip == widget.currentIp && d.port == widget.currentPort;
                  return ListTile(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                Text(
                  _done
                      ? (_cancelled ? '已取消' : '完成，共 ${_results.length} 台')
                      : '$_scanned / $total',
                  style: TextStyle(
                    fontSize: 11,
                    color: _done
          ...
          Padding(
            ...
            child: ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation(
                  _done ? cs.onSurface.withValues(alpha: 0.2) : AppTheme.brand,
                ),
              ),
            ),
          ),
                ...
                : Builder(
                    builder: (_) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (_, i) {
                          final r = sorted[i];
                          final saved = reg.devices
                              .where(
                                (d) => d.ip == r.ip && d.port == widget.port,
                              )
                              .firstOrNull;
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: (r.isRobot ? AppTheme.brand : cs.onSurface).withValues(
                alpha: 0.08,
              ),
...
class _ConnBtn extends StatefulWidget {
  ...
  @override
  State<_ConnBtn> createState() => _ConnBtnState();
}
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: widget.filled
                ? (_hov
                      ? AppTheme.brand.withValues(alpha: 0.85)
                      : AppTheme.brand)
                : (_hov
