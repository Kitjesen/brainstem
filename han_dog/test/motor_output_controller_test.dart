...
void main() {
  ...
  test('a failed Enable sends a best-effort Disable CAN request', () async {
  ...
  test(
    'maintenance never runs when a Disable CAN request does not complete',
    () async {
      ...
      expect(
        ...
        'previous motor Disable request has not completed',
      );
      expect(motor.enableCalls, 1);
    },
  );
